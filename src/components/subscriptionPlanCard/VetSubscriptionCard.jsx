...
export default function VetSubscriptionCard({ data, selectedPlan }) {
          ...
          <div className="w-full">
            ...
            <div className=" border-t  flex flex-col gap-4">
              <div className="flex pt-4 items-center gap-2">
                ...
                <div className="">
                  <h4 className=" text-xs lg:text-[16px] font-bold">VAT</h4>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="">
                  <h4 className=" text-xs lg:text-[16px] font-bold">Case Record</h4>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="">
                  <h4 className=" text-xs lg:text-[16px] font-bold">Duration</h4>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="">
                  <h4 className=" text-xs lg:text-[16px] font-bold">Products</h4>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="">
                  <h4 className=" text-xs lg:text-[16px] font-bold">Feed Calculator</h4>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="">
                  <h4 className=" text-xs lg:text-[16px] font-bold">Disease Predictor</h4>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="">
                  <h4 className=" text-xs lg:text-[16px] font-bold">Store</h4>
              ...
              <div className="flex items-center mb-14 gap-2">
                ...
                <div className="">
                  <h4 className=" text-xs lg:text-[16px] font-bold">Customer Support</h4>
