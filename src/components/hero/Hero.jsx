      ...
      <div className="hero__body w-[90%] md:w-[85%] h-[100%] flex flex-col-reverse m-auto space-y-2 md:flex md:flex-col-reverse lg:flex-row space-x-2  justify-between">
        <div className="hero__left pt-[3rem] md:pt-[6rem] flex flex-col space-y-4 lg:w-[40%]">
          ...
          <div className="store pt-4 flex items-center gap-2">
            <a
              href="https://play.google.com/store/apps/details?id=www.vetkonect.com"
              target="_blank"
              className="p-3.5 lg:px-5 bg-white rounded-full border-[1px] cursor-pointer border-gray-400 flex items-center gap-2"
              rel="noreferrer"
            >
            ...
            <a
              href="https://apps.apple.com/ng/app/vetkonect/id1661529111"
              target="_blank"
              rel="noreferrer"
              className="p-3.5 lg:px-5 bg-[#1D2432]  text-white cursor-pointer rounded-full border-[1px] border-gray-400 flex items-center gap-2"
            >
