    ...
    <div className="section pt-[10vh] pb-[10vh] bg-[--background] w-[100%]  bg-main">
      <div className="main w-[90%] md:w-[85%] m-auto flex flex-col-reverse  md:grid grid-cols-12 ">
        <div className="section__left col-span-8">
          <div className="title head__two">
          About Vet Konect
          </div>
          <div className="sub pt-4 md:pt-10 md:w-[80%]">
            <p className=" font-bold text-xl">Overview</p>
            <p className="paragraph pt-3">
                Vet Konect is a digital platform that provides quick access to veterinary care by connecting veterinarians, veterinary clinics and vendors to pet owners and livestock farmers by leveraging the use of technology.
            </p>
            <div className="section__cards flex flex-wrap pt-10 gap-2">
                <Cardcolor text={'Number of Veterinarians'} title={'8k+'} image={green}/>
                <Cardcolor text={'Number of Vet Clinics'} title={'5.7k+'} image={yellow}/>
                <Cardcolor text={'Vet Vendor & Store'} title={'9.3k+'}  image={orange}/>
                <Cardcolor text={'Pet Owners & livestock Farmers'} title={'2m+'}  image={red}/>
            </div>
            <div className="people pt-10">
              <img src={people} alt="" className=' h-[60px] object-contain' />
            </div>
          </div>
        </div>
        <div className="section__right col-span-4">
            <img src={aboutImg} alt=""className=' h-[100%] w-[100%] object-contain' />
        </div>
      </div>
    </div>
  );
