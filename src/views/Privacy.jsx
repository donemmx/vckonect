...
export default function Privacy() {
  return (
    <div className="">
      <Header />
      <div className="w-[90%] md:w-[80%] mx-auto py-[20vh]">
        <h1 className="text-4xl font-black py-2">Policies</h1>
        <h2 className="text-xl font-black flex items-center gap-2  py-2">
          Acceptable use policy
        </h2>
        <p className="text-sm md:text-lg  py-1">
          This acceptable use policy ("Policy") sets forth the general
          guidelines and acceptable and prohibited uses of the vetKonect.com
          website ("Website"), "VetKonect" mobile application ("Mobile
          ...
          between you ("User", "you" or "your") and this Website operator and
          Mobile Application developer ("Operator", "we", "us" or "our"). If you
          ...
          you, and it governs your use of the Services. This acceptable use
          policy was created with the help of the acceptable use policy
          generator.
        </p>
        <div className="">
          <h2 className="text-xl font-black flex items-center gap-2  py-2">
        ...
        <div className="">
          ...
          <p className="text-sm md:text-lg  py-1">
            ...
            comply with the U.S. CAN-SPAM Act of 2003 ("SPAM"). Your products or
            services advertised via SPAM (i.e. Spamvertised) may not be used in
            conjunction with the Services. This provision includes, but is not
        ...
        <div className="">
          ...
          <p className="text-sm md:text-lg  py-1">
            ...
            carried out if necessary. We will assume no liability to any User of
            the Services for the removal of any such material. If you believe
            your copyright is being infringed by a person or persons using the
        ...
        <div className="">
          ...
          <p className="text-sm md:text-lg  py-1">
            ...
            may not be able to provide you with one and, as such, you are
            strongly encouraged to take your own backups. Nothing contained in
            this Policy shall be construed to limit our actions or remedies in
            any way with respect to any of the prohibited activities. In
            addition, we reserve at all times all rights and remedies available
        ...
        <div className="">
          ...
          <p className="text-sm md:text-lg  py-1">
            ...
            such as through the contact information you have provided. An
            updated version of this Policy will be effective immediately upon
        ...
        <div className="">
          ...
          <p className="text-sm md:text-lg  py-1">
            Email: vetconnectng@gmail.com
          </p>
          <p className="text-sm md:text-lg  py-1">Phone: +2348066459317 </p>
          <p className="text-sm md:text-lg  py-1">
            This document was last updated on January 02, 2023{" "}
          </p>
        </div>
      </div>
      <Footer/>
