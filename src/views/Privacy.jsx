export default function Privacy() {
  return (
    <div className="w-[90%] md:w-[80%] mx-auto">
      <h1 className="text-3xl font-black py-2">Policies</h1>
      <h2 className="text-xl font-black flex items-center gap-2  py-2">Acceptable use policy</h2>
      <p className="text-sm md:text-lg  py-1">
        This acceptable use policy ("Policy") sets forth the general guidelines
        and acceptable and prohibited uses of the vetKonect.com website
        ("Website"), "VetKonect" mobile application ("Mobile Application") and
        ...
        "your") and this Website operator and Mobile Application developer
        ...
        Services. This acceptable use policy was created with the help of the
        acceptable use policy generator.
      </p>
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">Prohibited activities and uses</h2>
        <p className="text-sm md:text-lg  py-1">
        ...
        <ul className="text-sm md:text-lg list-inside list-disc">
      ...
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">System abuse</h2>
        <p className="text-sm md:text-lg  py-1">
      ...
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">Service resources</h2>
        <p className="text-sm md:text-lg  py-1">
      ...
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">No spam policy</h2>
        <p className="text-sm md:text-lg  py-1">
          ...
          CAN-SPAM Act of 2003 ("SPAM"). Your products or services advertised
          via SPAM (i.e. Spamvertised) may not be used in conjunction with the
          Services. This provision includes, but is not limited to, SPAM sent
          via fax, phone, postal mail, email, instant messaging, or newsgroups.
        </p>
      </div>
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">Defamation and objectionable content</h2>
        <p className="text-sm md:text-lg  py-1">
      ...
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">Copyrighted content</h2>
        <p className="text-sm md:text-lg  py-1">
          ...
          violation, we may, at our discretion, run an investigation and, upon
          confirmation, may remove the infringing material from the Services. We
          may terminate the Service of Users with repeated copyright
          infringements. Further procedures may be carried out if necessary. We
          will assume no liability to any User of the Services for the removal
          of any such material. If you believe your copyright is being infringed
          by a person or persons using the Services, please get in touch with us
          to report copyright infringement.
        </p>
      </div>
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">Security</h2>
        <p className="text-sm md:text-lg  py-1">
      ...
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">Enforcement</h2>
        <p className="text-sm md:text-lg  py-1">
        ...
        <p className="text-sm md:text-lg  py-1">
          ...
          re-activated. A backup of User's data may be requested, however, we
          may not be able to provide you with one and, as such, you are strongly
          encouraged to take your own backups. Nothing contained in this Policy
          shall be construed to limit our actions or remedies in any way with
          respect to any of the prohibited activities. In addition, we reserve
          at all times all rights and remedies available to us with respect to
          such activities at law or in equity.
        </p>
      </div>
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">Reporting violations</h2>
        <p className="text-sm md:text-lg  py-1">
      ...
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">Changes and amendments</h2>
        <p className="text-sm md:text-lg  py-1">
          ...
          Policy unless otherwise specified. Your continued use of the Services
      ...
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">Acceptance of this policy</h2>
        <p className="text-sm md:text-lg  py-1">
      ...
      <div className="">
        <h2 className="text-xl font-black flex items-center gap-2  py-2">Contacting us</h2>
        <p className="text-sm md:text-lg  py-1">
          If you have any questions, concerns, or complaints regarding this
          Policy, we encourage you to contact us using the details below:
        </p>
        <p className="text-sm md:text-lg  py-1">Email: vetconnectng@gmail.com</p>
        <p className="text-sm md:text-lg  py-1">Phone: +2348066459317 </p>
        <p className="text-sm md:text-lg  py-1">This document was last updated on January 02, 2023 </p>
      </div>
    </div>
  );
}
